...
# Based on https://github.com/HenriquesLab/DL4MicEverywhere/blob/main/notebooks/ZeroCostDL4Mic_notebooks/U-Net_2D_DL4Mic/configuration.yaml
...
def install():
    ...
    notebook_path = get_app_path().joinpath("U-Net_2D_ZeroCostDL4Mic.ipynb")
...
setup(
    ...
    tags=['AMD64', 'colab', 'notebook', 'U-Net', 'segmentation', 'ZeroCostDL4Mic', '2D', 'dl4miceverywhere'],
    args=[{
        "name": "path",
        "type": "string",
        "default": ".",
