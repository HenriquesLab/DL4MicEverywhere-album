...
# Based on https://github.com/HenriquesLab/DL4MicEverywhere/blob/main/notebooks/ZeroCostDL4Mic_notebooks/CARE_3D_DL4Mic/configuration.yaml
...
def install():
    ...
    notebook_path = get_app_path().joinpath("CARE_3D_ZeroCostDL4Mic.ipynb")
...
def run():
    ...
    notebook_path = app_path.joinpath("CARE_3D_ZeroCostDL4Mic.ipynb")
...
setup(
    ...
    tags=['AMD64', 'colab', 'notebook', 'CARE', 'denoising', 'ZeroCostDL4Mic', '3D', 'dl4miceverywhere'],
    args=[{
        "name": "path",
        "type": "string",
        "default": ".",
