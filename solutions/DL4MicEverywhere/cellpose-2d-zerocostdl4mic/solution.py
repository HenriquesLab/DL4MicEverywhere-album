...
# Based on https://github.com/HenriquesLab/DL4MicEverywhere/blob/main/notebooks/ZeroCostDL4Mic_notebooks/Cellpose_2D_DL4Mic/configuration.yaml
...
def install():
    ...
    notebook_url = "https://raw.githubusercontent.com/HenriquesLab/ZeroCostDL4Mic/master/Colab_notebooks/Cellpose_2D_ZeroCostDL4Mic.ipynb"
    
    notebook_path = get_app_path().joinpath("Cellpose_2D_ZeroCostDL4Mic.ipynb")
    ...
    python_command = ["python", ".tools/notebook_autoconversion/transform.py", "-p", f"{get_app_path()}", "-n", "Cellpose_2D_ZeroCostDL4Mic.ipynb", "-s"]
    python_command += section_to_remove

    subprocess.run(python_command, cwd=to)
    subprocess.run(["mv", get_app_path().joinpath("colabless_Cellpose_2D_ZeroCostDL4Mic.ipynb"), get_app_path().joinpath("Cellpose_2D_ZeroCostDL4Mic.ipynb")])
...
def run():
    ...
    notebook_path = app_path.joinpath("Cellpose_2D_ZeroCostDL4Mic.ipynb")
